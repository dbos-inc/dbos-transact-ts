...
describe('dbos-config', () => {
  ...
  describe('Configuration loading', () => {
    test.skip('loadConfigFile translates otlp endpoints from string to list', () => {
    ...
    test.skip('loadConfigFile supports array otlp endpoints', () => {
      const mockConfigFile = `
        database:
            hostname: \${DOESNOTEXISTS}
            port: \${DOESNOTEXISTS}
  ...
  describe('processConfigFile', () => {
    test.skip('processConfigFile translates otlp endpoints from string to list', () => {
      const mockConfigFile = `
        name: 'test-app'
        telemetry:
            OTLPExporter:
      ...
      const config = translateDbosConfig(configFile);
    ...
    test.skip('processConfigFile support array oltp endpoints', () => {
      const mockConfigFile = `
        name: 'test-app'
        telemetry:
            OTLPExporter:
    ...
    test.skip('processConfigFile logLevel specified', () => {
      const mockConfigFile = `
        name: 'test-app'
        telemetry:
            logs:
    ...
    test.skip('processConfigFile logLevel override', () => {
      const mockConfigFile = `
        name: 'test-app'
        telemetry:
            logs:
    ...
    test('processConfigFile forceConsole override', () => {
      ...
      const configFile = readConfigFile();
      const config = translateDbosConfig(configFile, true);
    ...
    test.skip('processConfigFile returns correct database url', () => {
      const mockConfigFile = `
        name: 'test-app'
  ...
  describe('constructPoolConfig', () => {
    ...
    test.skip('uses default values when config is empty', () => {
      const config = baseConfig();
      const databaseUrl = getDatabaseUrl(config);
      expect(databaseUrl).toBe(
        'postgresql://postgres:dbos@localhost:5432/test_app?connect_timeout=10&sslmode=no-verify',
      );
    });

    test.skip('gets db name from  pkg json name', () => {
    ...
    test.skip('throws when app name and package.json are missing', () => {
    ...
    test.skip('uses environment variable overrides', () => {
      ...
      expect(url).toBe('postgresql://envuser:envpass@envhost:7777/test_app?connect_timeout=10&sslmode=no-verify');
    });
    ...
    test.skip('uses mixed parameters from defaults, config, and environment', () => {
    ...
    test.skip('respects ssl_ca and builds verify-full connection string', () => {
    ...
    test.skip('parses all connection parameters from database_url, backfill poolConfig and ignore provided configFile.database parameters', () => {
    ...
    test.skip('constructPoolConfig correctly handles app names with spaces', () => {
      //   const config = baseConfig();
    ...
    test.skip('constructPoolConfig throws with invalid database_url format', () => {
      const config = baseConfig();
    ...
    test.skip('constructPoolConfig throws when database_url is missing required fields', () => {
  ...
  describe('Configuration parsing', () => {
    ...
    test.skip('Config is valid and is parsed as expected', () => {
    ...
    test.skip('fails to read config file', () => {
    ...
    `;
      ...
      expect(() => getDbosConfig(config)).toThrow(DBOSInitializationError);
    });
  });
