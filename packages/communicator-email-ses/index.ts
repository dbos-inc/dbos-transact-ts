...
class DBOS_SES extends ConfiguredInstance {
      ...
      return await ses.sendEmail({
        ...
        Content: {
          Simple: {
            ...
            Body: {
              Html: mail.bodyHtml ? { Data: mail.bodyHtml } : undefined,
  ...
  @DBOS.step()
  async sendTemplatedEmail(templatedMail: {
    to?: string[];
    cc?: string[];
    bcc?: string[];
    from: string;
   ...
   */
  @DBOS.step()
  async createEmailTemplate(templateName: string, template: { subject: string; bodyHtml?: string; bodyText?: string }) {
...
export { SendEmailCommunicator, SendEmailCommunicator as SendEmailStep, DBOS_SES };
